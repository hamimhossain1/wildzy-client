...
const About = () => {
    return (
        <div className="hero mt-8  lg:mt-20 mb-10 md:mb-16 lg:mb-24">
            
            <div className="hero-content flex-col lg:flex-row">
                <div className=' lg:w-1/2 relative'>
                <p className='text-2xl lg:hidden text-center text-purple-700 font-bold mb-4'>About Wildzy</p>
                ...
                <div className=' w-10/12 lg:w-1/2 mt-24 lg:m-0'>
                    <p className='text-2xl hidden lg:block text-purple-700 font-bold mb-4'>About Wildzy</p>
